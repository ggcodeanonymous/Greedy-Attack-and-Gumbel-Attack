...
The AG's News data set is provided [here](https://drive.google.com/open?id=0Bz8a_Dbh9QhbUDNpeUdjb0wxRms). After downloading it, please put it in the directory agccnn/data/. The weights of a trained character-level convolutional networks (Char-CNN) are provided [here](https://drive.google.com/open?id=1dkt_sfRPJzQO3uMA4afcSRgNMFfOrk3M). After downloading it, please put it in the directory agccnn/params/.
